...
const Lead = (props) => {
                ...
                <div className = {classes.root}>
                    <Grid container spacing = {3}>
                        <Grid item sm = {12} md = {6} lg = {4}>
                            <Link to = '/lead-coach/lmeeting' style = {{textDecoration: 'none', color: 'black'}}>
                        ...
                        <Grid item sm = {12} md = {6} lg = {4}>
                            <Link to = '/lead-coach/lmessage' style = {{textDecoration: 'none', color: 'black'}}>
                                <Paper className = {classes.paper}>
    ...
    return (
        <Router history = {props.history}>
            <Switch>
                <Route exact path = '/lead-coach' component = {LeadWithCard} />
                <Route path = '/lead-coach/lmeeting' render = {() => Components[0]}></Route>
                <Route path = '/lead-coach/lmessage' render = {() => Components[1]}></Route>
            </Switch>
        </Router>
    );
};
