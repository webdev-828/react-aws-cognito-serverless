...
import { GET_ADMIN_HCS } from './../../graphql/admin/gql_admin_hcs';
...
const AdminHeadCounselors = (props) => {
    props.onFetchUser();  
    //var students = [];
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const { client } = props;
            const { data } = await client.query({query: GET_ADMIN_HCS, variables: {user_type: 'head_coach'}});
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withApollo(AdminHeadCounselors));
